...
@Mod(Crafters_of_the_carribean_Mod.MOD_ID)
public class Crafters_of_the_carribean_Mod
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "crafters_of_the_carribean_mod";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public Crafters_of_the_carribean_Mod(FMLJavaModLoadingContext context)
    {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        if(event.getTabKey() == CreativeModeTabs.INGREDIENTS) {
            event.accept(ModItems.CRYSTALLITE);
